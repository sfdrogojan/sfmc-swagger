...
if [ "$GIT_REMOTE" = "" ]; then
    git remote add origin-with-token https://${GIT_USER_ID}:${GITHUB_TOKEN}@github.com/${GIT_USER_ID}/${JAVA_SDK_GIT_REPO_ID}.git
fi
...
echo "Git pushing to https://github.com/${GIT_USER_ID}/${JAVA_SDK_GIT_REPO_ID}.git"
