...
java -cp $CUSTOM_GENERATOR_JAR:$CLI_JAR io.swagger.codegen.SwaggerCodegen generate -l csharp -i ../openapi-2.0/sfmc-openapi-v2.json -o $cSharpSdkGitRepoFolder -c ../openapi-2.0/swagger-codegen-config.json
exit $?